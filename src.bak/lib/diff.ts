 ...
 *
 * @param {string} oldText - The previous version.
 * @param {string} newText - The current version.
 * @returns {Array<{type: string, oldLine?: string, newLine?: string, oldIndex?: number, newIndex?: number}>}
 */
...
module.exports = { diffLines, renderUnified, diffStats };