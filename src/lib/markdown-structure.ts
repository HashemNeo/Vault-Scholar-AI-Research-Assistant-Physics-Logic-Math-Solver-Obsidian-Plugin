 ...
 */
export function parseStructure(text: string): MarkdownStructure {
 ...
 */
export function structuralDiff(oldStruct: MarkdownStructure, newStruct: MarkdownStructure): StructuralChange[] {
 ...
 */
export function renderStructuralDiff(changes: StructuralChange[]): string {
